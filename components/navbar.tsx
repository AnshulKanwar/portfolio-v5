  ...
  return (
    <nav className="flex justify-around py-10">
      ...
      <div className="flex gap-20 text-neutral-300 dark:text-neutral-700">
        <a className="cursor-pointer transition hover:text-black dark:hover:text-white">Blog</a>
        <a className="cursor-pointer transition hover:text-black dark:hover:text-white">Notes</a>
